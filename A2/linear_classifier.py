...
def svm_loss_vectorized(
    ...
    scores = X.mm(W)                                        #(64,10)
    correct_class_score = scores[range(num_train),y]        #(64,)
    margin = scores - correct_class_score.view(-1,1) + 1    #(64,10)
...
def softmax_loss_vectorized(
    ...
    scores = X.mm(W)
    scores = scores - scores.max(dim = 1)[0].view(-1,1)
    scores = scores.exp()
